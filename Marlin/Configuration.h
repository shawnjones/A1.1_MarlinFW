...
#define STRING_CONFIG_H_AUTHOR "(Shawn Jones, initial configuration for A1.1 machine.)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Printer A1.1"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 381 } // 381 from FB config file
